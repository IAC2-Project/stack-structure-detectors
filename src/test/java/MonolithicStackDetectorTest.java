...
class MonolithicStackDetectorTest {
    ...
    void minCutWeightScoreInput0() {
        assertEquals(0,
            MonolithicStackDetector.getMinCutWeightScore(0.0));
    }

    @Test
    void minCutWeightScoreInput1() {
        assertEquals(1,
            MonolithicStackDetector.getMinCutWeightScore(1.0));
    }

    @Test
    void minCutWeightScoreInput3() {
        assertEquals(0.75,
            MonolithicStackDetector.getMinCutWeightScore(3.0));
    }
    ...
    */
    ...
    @Test
    void densityScore1() {
        double densityScore = Math.round(MonolithicStackDetector.getDensityScore(1.0) * 100) / 100.0;
        assertEquals(1.0, densityScore);
    }

    @Test
    void densityScoreEinhalb() {
        double densityScore = Math.round(MonolithicStackDetector.getDensityScore(0.5) * 100) / 100.0;
